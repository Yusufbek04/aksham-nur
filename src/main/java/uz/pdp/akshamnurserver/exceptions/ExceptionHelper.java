package uz.pdp.akshamnurserver.exceptions;
...
//        ex.printStackTrace();
//        return new ResponseEntity<>(
//                ApiResult.errorResponse(MessagesEnum.INTERNAL_SERVER_ERROR.name(), 500),
//                HttpStatus.INTERNAL_SERVER_ERROR);
//    }
...
//    @ExceptionHandler(value = {ai.ecma.viewservice.exception.RestException.class})
//    public ResponseEntity<ApiResult<ErrorData>> handleExceptionForViewService(RestException ex) {
//        ex.printStackTrace();
//        //AGAR RESOURSE TOPILMAGANLIGI XATOSI BO'LSA CLIENTGA QAYSI TABLEDA NIMA TOPILMAGANLIGI HAQIDA XABAR QAYTADI
//        if (ex.getFieldName() != null)
//            return new ResponseEntity<>(ApiResult.errorResponse(ex.getUserMsg(), ex.getStatus().value()), ex.getStatus());
